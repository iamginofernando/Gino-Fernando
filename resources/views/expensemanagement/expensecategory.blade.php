...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Expense Management > Expense Category
            <small></small>
        </h1>
        <!-- END PAGE TITLE-->
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase font-green-haze">Expense Category</span>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <th>Description</th>
                                    <th>Created At</th>
                                    <tbody id="expensecategory_list">
                                        
                                    </tbody>
                                </table>
                                <a class="btn btn-default pull-right" onclick="add();"> Add Category </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- END CONTENT -->
@include('components.manageexpensecategory')
@endsection
@section("page-script")
...
<script src="{{ asset('js/expensecateg.js') }}" type="text/javascript"></script>
